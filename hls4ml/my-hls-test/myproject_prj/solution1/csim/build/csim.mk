...
AUTOPILOT_ROOT := G:/Xilinx/Vivado_HLS/2017.2
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := G:/Xilinx/Vivado_HLS/2017.2/msys/bin
endif
...
IFLAG += -IG:/Physics/Particle_Physics/B-Physics/hls4ml-bdt/bdt_utils -std=c++0x 
IFLAG += -g
IFLAG += -DNT
...
$(ObjDir)/myproject_test.o: ../../../../myproject_test.cpp $(ObjDir)/.dir
	...
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -IG:/Physics/Particle_Physics/B-Physics/hls4ml-bdt/bdt_utils -std=c++0x  $(IFLAG) $(DFLAG) $< -o $@ ; \
